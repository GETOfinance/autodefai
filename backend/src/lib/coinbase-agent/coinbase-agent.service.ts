  ...
  async initializeAgent() {
    try {
      ...
      const agent = createReactAgent({
        ...
        faucet if you are on network ID 'Open Campus Codex'. If not, you can provide your wallet details and request
